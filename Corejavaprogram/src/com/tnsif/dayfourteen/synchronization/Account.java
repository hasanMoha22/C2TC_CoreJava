...
public class Account implements Bank {
	...
	@Override
	public synchronized void deposit(int amt) throws Depositlimit {
		if (amt > 25000)
			throw new Depositlimit("Daily limit exceeds...");
		else {
			balance += amt;
	...
	@Override
	public synchronized void withdraw(int amt) throws Insufficientbalance {
